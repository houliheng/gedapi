...
/**
 * @reqno:H1509100097
 * @date-designer:2015年9月30日-lirongchao
 * 
 * 
 * @date-author:2015年9月30日-lirongchao:
 *  echars  实例化的实例 该版本做过调整 
 *  1、调整了js 的home属性 
 *  
 *  用来控制echarts的主目录
 *   
...
if (themeSelector) {
    ...
    function selectChange(value){
        ...
        if (theme != 'default') {
            ...
            require(['echarts/asset/theme/' + theme], function(tarTheme){
                curTheme = tarTheme;
...
function launchExample() {
    ...
    require(
        [
            'echarts',
            'echarts/asset/theme/' + hash.replace('-en', ''),
            'echarts/chart/line',
            'echarts/chart/bar',
