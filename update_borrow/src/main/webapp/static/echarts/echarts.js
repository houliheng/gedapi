...
define('zrender/zrender', [
    ...
    Tooltip.prototype = {
        ...
        _showItemTrigger: function (axisTrigger) {
            ...
            console.log("_showItemTrigger:"+this._curTarget);
            var serie = ecData.get(this._curTarget, 'series');
    ...
    if (!document.createElement('canvas').getContext) {
        (function () {
            ...
            contextPrototype.drawText_ = function (text, x, y, maxWidth, stroke) {
             ...
             //   
                lineStr.push('<g_vml_:skew on="t" matrix="', skewM+"drawText_", '" ', ' offset="', skewOffset, '" origin="', left, ' 0" />', '<g_vml_:path textpathok="true" />', '<g_vml_:textpath on="true" string="', encodeHtmlAttribute(text), '" style="v-text-align:', textAlign, ';font:', encodeHtmlAttribute(fontStyleString), '" /></g_vml_:line>');
                this.element_.insertAdjacentHTML('beforeEnd', lineStr.join(''));
            };
