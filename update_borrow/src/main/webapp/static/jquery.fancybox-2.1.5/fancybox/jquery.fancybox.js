...
(function (window, document, $, undefined) {
	...
	$.extend(F, {
		...
		defineToggle: function (direction) {
			// Help browser to restore document dimensions
			if(!count){
				count = true;
				F.trigger('onReady');
		...
		defineMytest: function(){
			F.inner.width(F.inner.width()*1.2);
			F.wrap.width(F.inner.width()+30);
			F.inner.height(F.inner.height()*1.2);
			F.wrap.height(F.inner.height()+30);
			F.trigger('onUpdate');
			F.reposition();
		},
		
		defineToggleOn: function () {
//			// Help browser to restore document dimensions
			$("#fancybox-img").height("100%").width("100%");
			F.inner.width(F.inner.width()/1.2);
			F.wrap.width(F.inner.width()+30);
		...
		rot : function(f_w,f_h,translate){  
		        if(rad/90%2){  
		        	$("#fancybox-img").css("-ms-transform","rotate("+rad+"deg)");
		        	//$("#fancybox-content").css("-ms-transform","rotate("+rad+"deg)");
		        	$("#fancybox-img").height(f_h).width(f_w);  
		            $("#fancybox-content").height(f_h).width(f_h);  
		            $("#fancybox-wrap").width($("#fancybox-img").width()+20);
		            $("#fancybox-wrap").height($("#fancybox-img").height()+20);
		            ...
		            $("#fancybox-img").height("100%").width("100%");  
		            $("#fancybox-content").height(f_h).width(f_h+200);  
