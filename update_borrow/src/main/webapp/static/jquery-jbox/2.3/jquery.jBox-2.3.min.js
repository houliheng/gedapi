(function(a) {
	a.jBox = function(b, c) {
		...
		if (c.id == undefined) {
			c.id = "jBox_" + Math.floor(Math.random() * 1000000)
		}
		...
		j.push("</div>");
		j.push("</div>");
		var k = '<iframe name="jbox-iframe-' + c.id + '" id="jbox-iframe" width="100%" height="100%" marginheight="0" marginwidth="0" frameborder="0" scrolling="' + c.iframeScrolling + '"></iframe><form id="jbox-iframe-form-' + c.id + '" method="post" target="jbox-iframe-' + c.id + '"></form>';
		var l = a(window);
