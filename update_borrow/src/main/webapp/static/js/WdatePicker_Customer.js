 ...
 * @date-author:2015年10月26日-songmin:这里因为My97DatePicker组件在“本单位入职日期”显示时出现   当滚动条移至最下方时，“本单位入职日期”的日期控件位置不在输入框上下这样一个bug
 * 这里将if判断条件($.topM + H.bottom + E > D.height) && ($.topM + H.top - E > 0) 改为了  ($.topM + H.top - E > 0)
 * 该文件目前仅在客户信息页面使用，如果其他页面需要使用该文件需要对所有日期组件都做测试，以确保不会出现问题
 */
