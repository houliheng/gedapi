	...
	<!-- /**
			 ...
			 * @date-author:20150629-zhangxingyu:1.将Resoft放在配置文件中
												 2.将第一个2005放在配置文件中
											  	 3.去掉“GDS基础平台”外的a标签
			 */ -->
		Copyright &copy; 2005-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('copyright.productName')}</a> - Powered By <a href="http://www.resoft.css.com.cn" target="_blank">Resoft</a> ${fns:getConfig('version')}
	</div>
