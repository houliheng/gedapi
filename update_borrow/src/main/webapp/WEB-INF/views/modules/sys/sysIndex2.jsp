	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"><span id="productName">${fns:getConfig('copyright.productName')}</span></div>
	    ...
	    <div class="container-fluid">
			 ...
			 * 
			 * 
			 * @date-author:20150629-zhangxingyu:1.将Resoft放在配置文件中
												 2.将第一个2005放在配置文件中
											  	 3.去掉“GDS基础平台”外的a标签
			 */ -->
	            Copyright &copy; 2005-${fns:getConfig('copyrightYear')} ${fns:getConfig('copyright.productName')}<!--  - Powered By <a href="http://www.resoft.css.com.cn" target="_blank">Resoft</a> ${fns:getConfig('version')} -->
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
