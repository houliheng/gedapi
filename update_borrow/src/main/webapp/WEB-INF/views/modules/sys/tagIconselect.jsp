...
<div id="icons">
	 ...
	 * 
	 * 
	 * @date-author:20150630-zhangxingyu:无法显示是因为图片库中不存在对应图标，删除无法显示的图标名称   删掉i标签中的第一位的空格
	 */ -->
	    ...
	    <ul class="the-icons">
	      ...
	      <!-- /**
			 ...
			 * @e-out-char :i : 图标标签
			 * @date-author:20150709-zhangxingyu:该css文件用来存放新加入的图标样式，
			 * 						新加入了.icon-sys-arrow-left ,.icon-sys-arrow-right,.icon-sys-table,
			 						icon-sys-accept,icon-sys-add图标
			 */ -->
	      <li><i class="icon-sys-arrow-left"></i>icon-sys-arrow-left</li>
	      <li><i class="icon-sys-arrow-right"></i>icon-sys-arrow-right</li>
	      <li><i class="icon-sys-table"></i>icon-sys-table</li>
	      <li><i class="icon-sys-accept"></i>icon-sys-accept</li>
	      <li><i class="icon-sys-add"></i>icon-sys-add</li>
	      <!-- end -->
	    </ul>
