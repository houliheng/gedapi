...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="cms:article:edit"><li><a href="<c:url value='${fns:getAdminPath()}/cms/article/form?id=${article.id}&category.id=${article.category.id}'></c:url>">文章添加</a></li></shiro:hasPermission>
	</ul>
