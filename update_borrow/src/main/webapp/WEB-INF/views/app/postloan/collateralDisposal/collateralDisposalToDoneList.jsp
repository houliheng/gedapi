...
<body>
	<div class="wrapper">
		<div class="searchInfo">
			...
			<div class="searchCon">
				<form:form id="searchForm" modelAttribute="collateralDisposal" action="${ctx}/postloan/collateralDisposal/toDoneList" method="post" class="breadcrumb form-search">
					...
					<tbody>
						<c:forEach items="${page.list}" var="TaskTempEntity">
							<tr>
								...
								<td id="oprateId" class="title" title="${TaskTempEntity.oprateId}">${TaskTempEntity.oprateId}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
