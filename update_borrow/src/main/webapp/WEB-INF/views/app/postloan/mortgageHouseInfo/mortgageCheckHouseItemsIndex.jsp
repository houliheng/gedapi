...
<script type="text/javascript">
	$(document).ready(function() {
		$.loadDiv("mortgageEvaluateItemsList", "${ctx}/postloan/mortgageEvaluateInfo/editInfo", {
			 applyNo : '${mortgageHouseInfo.applyNo}',infoId:'${mortgageHouseInfo.id}' 
		}, "post"); 
	});
 	function page(n, s) {
		$("#pageNo").val(n);
...
<body>
		<!-- 房屋抵质押物基本信息 -->
	<div id="mortgageHouseEvaluateInfoFormDiv">
		<%@ include file="/WEB-INF/views/app/postloan/mortgageHouseInfo/mortgageHouseEvaluateInfoForm.jsp"%>
	</div> 
	<!-- 抵质押物检查信息 -->
