...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$("#uploadify").uploadify({
			...
			'uploader' : '${ctx}/postloan/uploadFile/upload;JSESSIONID=<shiro:principal property="sessionid"/>',
			...
			/* 'onSelect' : function(file) { //当选中一个文件时,计数器+1
				count++;
				$("#uploadify").uploadify('settings', 'formData', {'applyNo': '${applyNo}','contractNo':'${contractNo}'});
 	...
 	function doUpload() {
 		$("#uploadify").uploadify('settings', 'formData', {'applyNo':'${applyNo}'});
