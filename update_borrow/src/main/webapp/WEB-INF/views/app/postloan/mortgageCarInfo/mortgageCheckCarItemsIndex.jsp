...
<script type="text/javascript">
	$(document).ready(function() {
			 ...
			 applyNo : '${mortgageCarInfo.applyNo}',infoId:'${mortgageCarInfo.id}' 
		}, "post"); 
	});
 	function page(n, s) {
		$("#pageNo").val(n);
...
<body>
		<!-- 车辆抵质押物基本信息 -->
	<div id="mortgageCarEvaluateInfoFormDiv">
		<%@ include file="/WEB-INF/views/app/postloan/mortgageCarEvaluateInfo/mortgageCarEvaluateInfoForm.jsp"%>
	</div>
	<!-- 抵质押物检查信息 -->
