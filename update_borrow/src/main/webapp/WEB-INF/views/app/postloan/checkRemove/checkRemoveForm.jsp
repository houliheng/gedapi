...
<script type="text/javascript">
	...
	function saveForm() {
		...
		$.post("${ctx}/postloan/checkRemove/save", formJson, function(data) {
			if (data) {
			closeTip();
				if (data.status == 1) {
...
<body>
	<form:form id="inputForm" modelAttribute="checkRemove" action="#" method="post" class="form-horizontal">
		...
		<table class="fromTable filter">
			<tr>
				<td class="ft_label">核销原因：</td>
				<td class="ft_content" colspan="5">
					<form:textarea path="applySuggestion" rows="5" class="textarea-width textarea-style required" maxlength="1000" htmlEscape="false" />
					<font color="red">*</font>
				</td>
			</tr>
			<tr>
