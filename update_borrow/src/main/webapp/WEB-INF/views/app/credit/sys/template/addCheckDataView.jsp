	...
	<div class="wrapper">
		<div class="infoList">
			<c:if test="${not empty updateTemplate}">
				<h3 class="infoListTitle">修改资料核查模板配置信息</h3>
			</c:if>
			<c:if test="${empty updateTemplate}">
	    		<h3 class="infoListTitle">新增资料核查模板配置信息</h3>
	    	</c:if>
	        <div class="infoListCon">
				<form:form id="inputForm" modelAttribute="template" action="${ctx}/credit/sys/template/saveDoubtful" method="post" target="spare">
					<div class="filter">
						<table class="fromTable">
							...
							<tr>
								...
								<td class="ft_content">
									...
									<input id="fileType" name="fileType" value="2" type="hidden">
									<span class="help-inline"><font color="red" id="meg">*</font> </span>
								</td>
							</tr>
						</table>
						<div class="searchButton">
							<input id="submitButton" class="btn btn-primary" type="button" onclick="javascript:submitForm();" value="保 存" />&nbsp;
