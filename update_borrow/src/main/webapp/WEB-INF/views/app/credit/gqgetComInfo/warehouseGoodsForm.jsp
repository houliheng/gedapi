...
<script type="text/javascript">
	$(document).ready(function() {
		...
		submitHandler : function(form) {
			...
			$.post("${ctx}/credit/gqgetComInfo/warehouseSave", param, function(data) {
				if (data) {
					closeTip();
					if (data.status == "1") {
						alertx(data.message, function() {
							parent.$.loadDiv('warehouse', '${ctx}/credit/gqgetComInfo/warehouseList', {
								applyNo : $("#applyNo").val()
							}, 'post');
							closeJBox();
						});
		...
		<div class="searchCon">
			<form:form id="warehouseForm" modelAttribute="warehouseGoods" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<form:select path="wareType" class="input-medium required" onclick="propertySelect();">
