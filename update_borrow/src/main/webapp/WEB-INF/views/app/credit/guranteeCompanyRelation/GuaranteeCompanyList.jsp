...
<script type="text/javascript">
    ...
    function addGuarantor111() {
        ...
        var url = "${ctx}/credit/creApplyCompanyRelation/selectCompanyList?companyFlag="+flag+"&applyId="+applyId+"&custId="+custId;
    ...
    function deleteGuaranteeCompany(id){
        confirmx('确认要解除该担保公司信息吗？', function() {
            $.ajax({
                url:"${ctx}/credit/creApplyCompanyRelation/deleteCompanysd",
                data:{
                    id :id
                },
                type : "post",
...
<div class="tableList">
    ...
    <div id="tableDataId" style="max-height: 400px; overflow: auto;">
        <div class="searchInfo">
            <h3 onclick="guaranefg()" class="searchTitle">第三方担保公司</h3>
            <div id="companyddd" class="ribbon filter">
                <ul class="layout">
                    <li class="add">
