...
<script type="text/javascript">
	...
	function addWarehouse() {
		openJBox('addWarehouseBox', "${ctx}/credit/gqgetComInfoUnion/warehouseForm", "新增库存货物信息", 1000, 350, {
			applyNo : $("#applyNo").val(),
			approId:'${warehouseGoods.approId}'
		});
	...
	function editWarehouse() {
		...
		if (id.length != 1) {
			...
			openJBox('editWarehouseBox', "${ctx}/credit/gqgetComInfoUnion/warehouseForm", "编辑库存货物信息", 1000, 350, {
			id : id,
			applyNo : $("#applyNo").val(),
			approId:'${warehouseGoods.approId}'
			});
