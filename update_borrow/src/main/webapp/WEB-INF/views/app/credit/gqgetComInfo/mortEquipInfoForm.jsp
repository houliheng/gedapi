...
<script type="text/javascript">
	$(document).ready(function() {
		...
		submitHandler : function(form) {
			...
			$.post("${ctx}/credit/gqgetComInfo/equipsave", param, function(data) {
				if (data) {
					closeTip();
					if (data.status == "1") {
						alertx("新增抵押设备保存成功", function() {
							parent.$.loadDiv('equip', '${ctx}/credit/gqgetComInfo/mortEquip', {
								applyNo:$("#applyNo").val()
							}, 'post');
							closeJBox();
						});
...
<body>
	<div class="searchInfo">
		...
		<br>
		<div class="searchCon">
			<form:form id="equipForm" modelAttribute="mortageEquipment"  class="form-horizontal">
				<form:hidden path="id" />
				<input type="hidden" id="applyNo" name="applyNo" value="${mortageEquipment.applyNo}" />
