...
<script type="text/javascript">
	$(document).ready(function() {
		...
		submitHandler : function(form) {
			...
			$.post("${ctx}/credit/gqgetAssetHouseUnion/save", param, function(data) {
				if (data) {
					closeTip();
					if (data.status == "1") {
						alertx("新增房屋资产保存成功", function() {
							parent.$.loadDiv('assetHouse', '${ctx}/credit/gqgetAssetHouseUnion/list', {
...
<body>
	...
	<br />
	<form:form id="inputForm" modelAttribute="gqgetAssetHouseUnion" action="" method="post" class="form-horizontal">
