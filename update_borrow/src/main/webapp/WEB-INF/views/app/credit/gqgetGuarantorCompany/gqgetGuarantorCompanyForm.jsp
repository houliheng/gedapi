...
<script type="text/javascript">
	...
	function saveForm() {
		...
		$.post("${ctx}/credit/gqgetGuarantorCompany/save", formJson, function(data) {
			if (data) {
				if (data.status == 1) {//保存成功
					alertx(data.message, function() {
						parent.$.loadDiv("gqgetGuarantorCompanyInfo", "${ctx }/credit/gqgetGuarantorCompany/list", {
...
<body>
	<form:form id="gqgetGuarantorCompanyForm" modelAttribute="gqgetGuarantorCompany" action="" method="post" class="form-horizontal">
		<form:hidden path="id" />
