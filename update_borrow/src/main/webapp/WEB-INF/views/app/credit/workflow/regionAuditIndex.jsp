	...
	<div class="wrapper">
		...
		<div style="margin-top: 5px;">
			<ul class="nav nav-tabs" id="mainTabs">
				...
				<c:if test="${actTaskParam.taskDefKey eq 'utask_zgsfksh' || actTaskParam.taskDefKey eq 'utask_zgsjlsh' || actTaskParam.taskDefKey eq 'utask_zgszjlsh'}">
					<li class="line"></li>
					<li class="">
						<a href="#tab_dss" onclick="showDSSTab(true)">支持决策</a>
					</li>
				</c:if>
				<li class="line"></li>
				<li class="">
				...
				<li class="line"></li>
				<li >
					<a href="#" onclick="showPostViewImage('${actTaskParam.status}')">影像查看</a>
				</li>
				<li class="line"></li>
				<li class="">
