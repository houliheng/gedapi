...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			showAppointInfoTab('${actTaskParam.status == 1}')
		});
	</script>
</head>
<body>
	...
	<div class="wrapper">
		...
		<div style="margin-top: 5px;">
			<ul class="nav nav-tabs" id="mainTabs">
				...
				<li class="line"></li>
				<li class="">
					<a href="#tab_appointInfo" onclick="showAppointInfoTab('${actTaskParam.status == 1}')">预约信息</a>
				</li>
				<li class="line"></li>
				<li class="">
		...
		<div class="tab-content">
			...
			<div class="tab-pane" id="tab_appointInfo"></div>
