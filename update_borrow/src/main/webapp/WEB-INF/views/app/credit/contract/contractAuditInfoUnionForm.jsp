...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if(document.getElementById("qualityServiceMarginAmount") != null){
 		document.getElementById("qualityServiceMarginAmount").value = outputmoney("${contract.qualityServiceMarginAmount}");
		}
		...
		if ('${contract.serviceFeeType}' == "1") {
			...
			if('${contract.qualityServiceMarginAmount}' == null || '${contract.qualityServiceMarginAmount}' == "" ){
			document.getElementById("receiveAmount").value = outputmoney("${contract.marginAmount}");
			}else{
				document.getElementById("receiveAmount").value = outputmoney("${contract.marginAmount + contract.qualityServiceMarginAmount}");
			}
		}
					...
					<table class="fromTable filter">
						...
						<tr>
							...
							<td class="ft_content ZGCategory">
								<input type="text"  class="input-medium" readonly="true" value="${productCategoryKey}" />
							</td>
						</tr>
					</table>
				</div>
				...
				<div id="pfxxId" class="searchCon">
					<table class="fromTable filter">
						...
						<tr class="ZGCategory">
							...
							<td class="ft_content">
								<input type="text" name="addFundPeriod" value="${CGapproves.addFundPeriod}" maxlength="18" class="input-medium" />
								<font color="red">*</font>
							</td>
							<td class="ft_label">实际服务费（元）：</td>
							<td class="ft_content">
								<input type="text" value="${CGapproves.realityServiceFee}" maxlength="18" class="input-medium" readOnly="true" />
								<font color="red">*</font>
							</td>
							<%--<td class="ft_label classInterestRate">月息差（元）：</td>--%>
							<%--<td class="ft_content classInterestRate">--%>
								<%--<input type="text" name="interestRateDiff" value="${CGapproves.interestRateDiff }" onkeyup="keyPress11(this);" onblur="this.value=outputmoney(this.value);calculateAmount();"  maxlength="18" class="input-medium required" readOnly="true" />--%>
								<%--<font color="red">*</font>--%>
							<%--</td>--%>
						</tr>
						<tr>
							...
							<td class="ft_content">
								<input type="text" id="discountInterestRate" name="discountInterestRate" maxlength="5" readonly="readonly" value="${CGapproves.discountInterestRate}" onblur="this.value=rateMoney(this.value);" onkeyup="rateMax(this)" />
							</td>
							</c:if>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="ft_content">
								<input type="text" id="interestRateDiff" name="interestRateDiff" class="input-medium" readonly="readonly" value="${CGapproves.interestRateDiff}" />
							</td>
							<c:if test="${flowCode == '1'}">
								<td class="ft_label">利息月息差(元)：</td>
								<td class="ft_content">
									<input type="text" id="interestMonthlySpread" name="interestMonthlySpread" class="input-medium" readonly="readonly" value="${CGapproves.interestMonthlySpread}" />
								</td>
							</c:if>
						</tr>
						</c:if>
					...
					<tr class="cgisShow">
						...
						<tr>
							...
							<td class="ft_content" colspan="6">
								...
								<textarea id="remark" name="remark" htmlEscape="false" rows="6" maxlength="1500" class="textarea-width textarea-style" placeholder="此项填写为小黄表备注项">${contract.remark}</textarea>
							</td>
						</tr>
						...
						<table class="fromTable filter">
							...
							<tr>
								...
								<!-- <form:input path="recBankcardName" htmlEscape="false" readOnly="readOnly" maxlength="20" class="input-medium" onkeyup="loadBankCardInfo();" /> -->
									<!-- <form:select path="recBankcardName" disabled="true" class="input-medium required" onchange="loadBankCardInfo();getCustData();">
										<form:option value="">请选择</form:option>
