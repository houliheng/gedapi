...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if (!checkIsNull('${mortgageCarEvaluateInfo.mortgageCarInfo.operateProvince}')) {
			setName(data, "operate", '${mortgageCarEvaluateInfo.mortgageCarInfo.operateProvince}', '${mortgageCarEvaluateInfo.mortgageCarInfo.operateCity}', '${mortgageCarEvaluateInfo.mortgageCarInfo.operateDistinct}');
		}
	...
	function saveForm() {
		...
		$.post("${ctx}/credit/mortgageCarEvaluateInfo/save", formJson, function(data) {
			if (data) {
				closeTip();
				if (data.status == 1) {//保存成功
					alertx(data.message, function() {
						parent.$.loadDiv("mortgageCarEvaluate", "${ctx}/credit/mortgageCarEvaluateInfo/toCarEvaluateIndex", {
							applyNo : '${applyNo}'
						}, "post");
						closeJBox();
...
<body onload="propertyShow();">
	<form:form id="inputForm" modelAttribute="mortgageCarEvaluateInfo" action="${ctx}/credit/mortgageCarEvaluateInfo/save" method="post" class="form-horizontal">
			...
			<div class="filter">
				...
				<table class="fromtable">
					<tr>
						...
						<td class="ft_content">
							<form:select path="mortgageCarInfo.propertyRight" id="propertyRight" class="input-medium " disabled="true" onclick="propertySelect();">
						...
						<td class="ft_content">
							<form:input path="mortgageCarInfo.propertyName" name="mortgageCarInfo.propertyName" htmlEscape="false" maxlength="20" class="input-medium " readonly="true" />
							<font color="red">*</font>
						</td>
						<td class="ft_label">购置日期：</td>
						<td class="ft_content">
							<input id="buyDate" name="buyDate" type="text" name="mortgageCarInfo.buyDate" maxlength="20" class="input-medium Wdate " disabled="true" value="<fmt:formatDate value="${mortgageCarInfo.buyDate}" pattern="yyyy-MM-dd"/>" onclick="WdatePicker({onpicked:dateWhite(this),dateFmt:'yyyy-MM-dd',maxDate:new Date(),isShowClear:false});" />
						</td>
					</tr>
					<tr>
						<td class="ft_label">车辆品牌：</td>
						<td class="ft_content">
							<form:input path="mortgageCarInfo.vehicleBrand" name="mortgageCarInfo.vehicleBrand" htmlEscape="false" maxlength="10" class="input-medium " readonly="true" />
							<font color="red">*</font>
						</td>
						<td class="ft_label">车辆类型：</td>
						<td class="ft_content">
							<form:input path="mortgageCarInfo.vehicleType" name="mortgageCarInfo.vehicleType" htmlEscape="false" maxlength="10" class="input-medium " readonly="true" />
							<font color="red">*</font>
						</td>
						<td class="ft_label">车辆系列：</td>
						<td class="ft_content">
							<form:input path="mortgageCarInfo.vehicleSeries" name="mortgageCarInfo.vehicleSeries" htmlEscape="false" maxlength="50" class="input-medium " readonly="true" />
							<font color="red">*</font>
						</td>
					</tr>
					<tr>
						...
						<td class="ft_content">
							<form:select path="mortgageCarInfo.mortgageType" name="mortgageCarInfo.mortgageType" class="input-medium " disabled="true">
								<form:option value="" label="" />
			...
			<div class="filter" id="personal">
				...
				<table class="fromTable">
					<tr>
						...
						<td class="ft_content">
							<form:input path="mortgageCarInfo.propertyOfComOwners" name="mortgageCarInfo.propertyOfComOwners" htmlEscape="false" maxlength="20" class="input-medium " readonly="true" />
						</td>
						<td colspan="2"></td>
					</tr>
					<tr>
						...
						<td class="ft_content" colspan="5">
							<form:textarea path="mortgageCarInfo.otherInformation" name="mortgageCarInfo.otherInformation" id="otherInformation" htmlEscape="false" rows="4" maxlength="1000" class="input-xxlarge textarea-style textareaWidth" readonly="true" />
						</td>
					</tr>
				</table>
			</div>
			<div class="filter" id="company">
				...
				<table class="fromTable">
					<tr>
						...
						<td class="ft_content">
							<form:input path="mortgageCarInfo.busiRegName" htmlEscape="false" maxlength="300" class="input-medium " readonly="true" />
							<font color="red">*</font>
						</td>
						<td class="ft_label">营业执照号：</td>
						<td class="ft_content" colspan="5">
							<form:input path="mortgageCarInfo.busiLicRegNo" htmlEscape="false" maxlength="50" class="input-medium " readonly="true" />
							<font color="red">*</font>
						</td>
					</tr>
					<tr>
						...
						<td class="ft_content" colspan="4">
							<form:select path="mortgageCarInfo.operateProvince" id="operateProvince" disabled="true" class="input-small nuNullCheck" data-code="-1"></form:select>
							&nbsp;省
							<form:select path="mortgageCarInfo.operateCity" id="operateCity" disabled="true" class="input-small nuNullCheck" data-code="-1"></form:select>
							&nbsp;市
							<form:select path="mortgageCarInfo.operateDistinct" id="operateDistinct" disabled="true" class="input-small nuNullCheck" data-code="-1"></form:select>
							&nbsp;区&nbsp;
							<font color="red">*</font>
							<span style="width:13px;display: inline-block;"></span>
							<input type="text" name="mortgageCarInfo.operateDetails" id="operateDetails" readonly="true" class="input-medium" maxlength="200" value="${mortgageCarInfo.operateDetails}" style="margin: 0px;position: relative;display: inline-block;vertical-align: middle;" />
							<font color="red">*</font>
						</td>
					</tr>
					<tr>
						...
						<td class="ft_content">
							<form:input path="mortgageCarInfo.corporationName" htmlEscape="false" maxlength="300" class="input-medium " readonly="true" />
							<font color="red">*</font>
						</td>
						<td class="ft_label">法定代表人身份证号：</td>
						<td class="ft_content">
							<form:input path="mortgageCarInfo.corporationCardIdNo" htmlEscape="false" maxlength="18" class="input-medium " readonly="true" />
							<font color="red">*</font>
						</td>
					</tr>
					<tr>
						...
						<td class="ft_content">
							<form:input path="mortgageCarInfo.clientName" htmlEscape="false" maxlength="20" class="input-medium " readonly="true" />
							<font color="red">*</font>
						</td>
						<td class="ft_label">委托办理人身份证号：</td>
						<td class="ft_content">
							<form:input path="mortgageCarInfo.clientIdNo" htmlEscape="false" maxlength="18" class="input-medium " readonly="true" />
							<font color="red">*</font>
						</td>
					</tr>
					<tr>
						...
						<td class="ft_content">
							<form:input path="mortgageCarInfo.clientCompanyRelation" htmlEscape="false" maxlength="4" class="input-medium " readonly="true" />
							<font color="red">*</font>
						</td>
						<td class="ft_label">委托办理人联系方式：</td>
						<td class="ft_content">
							<form:input path="mortgageCarInfo.clientPhone" htmlEscape="false" maxlength="15" class="input-medium " readonly="true" />
							<font color="red">*</font>
						</td>
					</tr>
				</table>
