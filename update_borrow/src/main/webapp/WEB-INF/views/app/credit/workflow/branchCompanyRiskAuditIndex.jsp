...
<head>
	...
	<script type="text/javascript">
		...
		function hideGetInfoTab(){
			$("#getInfo").hide();
			$("#lineId").hide();
		}
		function showGetInfoTab(){
			$("#getInfo").show();
			$("#lineId").show();
		}
	</script>
	...
	<div class="wrapper">
		...
		<div style="margin-top: 5px;">
			<ul class="nav nav-tabs" id="mainTabs">
				...
				<li class="line"></li>
				<li class="">
					<a href="#tab_mortgageCarInfo" onclick="showMortgageCarEvaluateInfoTab('${actTaskParam.status == 1}')">抵质押物信息</a>
				</li>
			<!-- 	<li class="line"></li>
				<li class="">
				...
				<li class="line"></li>
				<li class="">
					<a href="#tab_financeImport" onclick="showFinanceImportTab('${actTaskParam.status == 1}')">财报导入</a>
				</li>
				<li class="line"></li>
				<li class="">
				...
				<li class="line"></li>
				<li class="">
					<a href="#tab_checkWeb" onclick="showCheckWebTab('${actTaskParam.status == 1}')">网查</a>
				</li>
				<li class="line"></li>
				<li class="">
					<a href="#tab_checkPhone" onclick="showCheckPhoneTab('${actTaskParam.status == 1}')">电话核查</a>
				</li>
				<c:if test="${actTaskParam.taskDefKey=='utask_fgsfksh' && showStatus=='1'}">
					<li class="line"></li>
					<li class="" id="tab_markNormLiId">
						<a href="#tab_markNormDiv" onclick="showMarkNormTab('${actTaskParam.status == 1}')">加减分项</a>
					</li>
				</c:if>
