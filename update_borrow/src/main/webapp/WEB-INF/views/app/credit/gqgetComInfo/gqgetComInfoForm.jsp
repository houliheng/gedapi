...
<script type="text/javascript">
	...
	function saveForm() {
		...
		$.post("${ctx}/credit/gqgetComInfo/save", formJson, function(data) {
			if (data) {
				closeTip();
...
<body>
	<form:form id="inputForm" modelAttribute="gqgetComInfo" action="${ctx}/credit/gqgetComInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id" />
				...
				<table class="fromTable filter">
					...
					<tr>
						...
						<td class="ft_content" colspan="5">
							<form:textarea path="intrOfCompany" htmlEscape="false" rows="5" maxlength="1000" class="textareaWidth textarea-style required checkNumberForty" onkeyup="adjustTextareaLength('intrOfCompany', 'preIntrOfCompany');" />
							<br>
							<font style="color: red">最少输入40字，最多可输入1000字</font>
						</td>
					</tr>
					<tr id="operateActualityId">
						...
						<td class="ft_content" colspan="5">
							<form:textarea path="operateActuality" htmlEscape="false" rows="5" maxlength="1000" class="textareaWidth textarea-style required checkNumberForty" onkeyup="adjustTextareaLength('operateActuality', 'preOperateActuality');" />
							<br>
							<font style="color: red">最少输入40字，最多可输入1000字</font>
						</td>
					</tr>
					<tr>
						...
						<td class="ft_content" colspan="5">
							<form:textarea path="mixLoanUsage" htmlEscape="false" rows="5" maxlength="1000" class="textareaWidth textarea-style required checkNumberTwenty" onkeyup="adjustTextareaLength('mixLoanUsage', 'preMixLoanUsage');" />
							<br>
					...
					<tr id="intrOfComProductionId">
						...
						<td class="ft_content" colspan="5">
							<form:textarea path="intrOfComProduction" htmlEscape="false" rows="5" maxlength="1000" class="textareaWidth textarea-style required checkNumberForty" onkeyup="adjustTextareaLength('intrOfComProduction', 'preIntrOfComProduction');" />
							<br>
							<font style="color: red">最少输入40字，最多可输入1000字</font>
						</td>
					</tr>
					<tr class="personCustType">
						...
						<td class="ft_content" colspan="5">
							<form:textarea path="borrowAndMatePunish" htmlEscape="false" rows="5" maxlength="30" class="textareaWidth textarea-style required" onkeyup="adjustTextareaLength('borrowAndMatePunish', 'preBorrowAndMatePunish');" />
							<br>
							<!-- <font style="color: red">最少输入40字，最多可输入1000字</font> -->
						</td>
					</tr>
					<tr class="personCustType">
						...
						<td class="ft_content" colspan="5">
							<form:textarea path="borrowInvolveInfo" htmlEscape="false" rows="5" maxlength="30" class="textareaWidth textarea-style required" onkeyup="adjustTextareaLength('borrowInvolveInfo', 'preBorrowInvolveInfo');" />
							<br>
							<!-- <font style="color: red">最少输入40字，最多可输入1000字</font> -->
						</td>
					</tr>
						...
						<td colspan="5">
							<table class="table table-striped table-bordered table-condensed">
								...
								<tbody>
									<tr>
										<td>
											<form:select path="bankLoan.isLoan" class="input-medium required" cssStyle="width:177px;">
												<form:option value="" label="请选择" />
												<form:options items="${fns:getDictList('IS_HAVE')}" itemLabel="label" itemValue="value" htmlEscape="false" />
											</form:select>
										</td>
										<td>
											<form:input type="hidden" path="bankLoan.id" id="bankLoanId" htmlEscape="false" readonly="true" class="input-medium" />
											<form:input type="text" path="bankLoan.loanRecode" htmlEscape="false" maxlength="3" class="input-medium required" />
										</td>
										<td>
											<form:select path="bankLoan.isOverdue" class="input-medium required" cssStyle="width:177px;">
												<form:option value="" label="请选择" />
												<form:options items="${fns:getDictList('IS_HAVE')}" itemLabel="label" itemValue="value" htmlEscape="false" />
											</form:select>
										</td>
										<td>
											<form:select path="bankLoan.sourceOfCreRegist" class="input-medium required" cssStyle="width:177px;">
												<form:option value="" label="请选择" />
					...
					<tr>
						<%-- <td class="ft_label">借款人在其他网贷平台的贷款情况：</td>
						<td class="ft_content">
			...
			<div id="comId">
				...
				<table class="fromTable filter">
					<tr>
						...
						<td class="ft_content">
							<input type="text" id="unSocCreditNo" name="unSocCreditNo" class="input-medium" readonly="true" value="${companyInfo.unSocCreditNo}" />
						</td>
