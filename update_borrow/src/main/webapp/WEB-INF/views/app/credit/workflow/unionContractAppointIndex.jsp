...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			showUnionAppointInfoTab('${actTaskParam.status == 1}');
		});
	</script>
</head>
<body>
	...
	<div class="wrapper">
		...
		<div style="margin-top: 5px;">
			<ul class="nav nav-tabs" id="mainTabs">
				...
				<li class="line"></li>
				<li class="">
					<a href="#tab_unionAppointInfo" onclick="showUnionAppointInfoTab('${actTaskParam.status == 1}')">预约信息</a>
				</li>
				<li class="line"></li>
				<li class="">
					<a href="#tab_gedAccount" onclick="showGedAccount('${actTaskParam.status == 1}')">创建冠易贷账号</a>
				</li>
				<li class="line"></li>
				<li class="">
		...
		<div class="tab-content">
			...
			<div class="tab-pane" id="tab_unionAppointInfo"></div>
			<div class="tab-pane" id="tab_gedAccount"></div>
