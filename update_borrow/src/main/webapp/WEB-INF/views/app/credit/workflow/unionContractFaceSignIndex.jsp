...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			showFaceSignUnionTab('${actTaskParam.status == 1}');
		});
	</script>
</head>
<body>
	...
	<div class="wrapper">
		...
		<div style="margin-top: 5px;">
			<ul class="nav nav-tabs" id="mainTabs">
				...
				<li class="line"></li>
				<li class="">
					<a href="#tab_faceSignUnion" onclick="showFaceSignUnionTab('${actTaskParam.status == 1}')">面签信息</a>
				</li>
				<li class="line"></li>
				<li class="">
		...
		<div class="tab-content">
			...
			<div class="tab-pane" id="tab_faceSignUnion"></div>
