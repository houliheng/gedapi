    ...
    <script type="text/javascript">
        ...
        function saveCompanyInfo() {
            if(($("#companyRegDistinct").val() == "-1") || ($("#operateDistinct").val() == "-1")){
                ...
                $.post("${ctx}/credit/creApplyCompanyRelation/saveCompany?flag=1", company, function(data) {
                        ...
                        if (data.status == 1) {
                            alertx(data.message, function() {
                                ...
                                parent.$.loadDiv("creCompanyInfoList", "${ctx}/credit/creApplyCompanyRelation/queryCompanyList", {
