            ...
            if(!companyId) {
                ...
                return false;
                     ...
                     //开始创建一个管理信息
                      ...
                      // companyId 担保公司id
                     $.ajax({
                         url:"${ctx}/credit/creGuaranteeCompany/saveRelation1111",
                         data:{
                             companyId : companyId,
                             applyNo : applyNo,
                         },
                         ...
                         success : function (data) {
                             if(data.status == 1){
                                 ...
                                 // 刷新信息
                                 var shanchu = 100;
                                 parent.$.loadDiv("guarantorCompanyList", "${ctx}/credit/creGuaranteeCompany/ApplyGuananteeList?shanchu="+shanchu, {
                                     applyNo : '${applyNo}'
                                 }, "post");
                                 closeJBox();
                             } else {
