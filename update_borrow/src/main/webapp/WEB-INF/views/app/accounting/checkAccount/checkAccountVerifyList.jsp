...
<script type="text/javascript">
    ...
    function checkAccountMatch(applyId) {
        var url = "${ctx}/accounting/checkAccountVerify/checkAccountMatch?applyId=" + applyId;
...
<div class="wrapper">
    <div class="searchInfo">
        ...
        <div class="searchCon">
            <form:form id="searchForm" modelAttribute="checkAccountVerify" action="${ctx}/accounting/checkAccountVerify"
                ...
                <tbody>
                    <c:forEach items="${page.list}" var="checkAccountVerify" varStatus="checkAccountVerifyList">
                        <tr>
                            ...
                            <td class="title">
                                <a href="#" onclick="checkAccountMatch('${checkAccountVerify.applyId}')">匹配</a>
