                ...
                <tbody>
                    <c:forEach items="${page.list}" var="checkAccount" varStatus="checkAccountList">
                        <tr>
                            ...
                            <td class="title" title="${checkAccount.applyStatus}">${checkAccount.applyStatus}</td>
                            <td class="title" title="${checkAccount.checkAmount}">${checkAccount.checkAmount}</td>
                            ...
                            <td class="title">
                                <a href="#" onclick="listCheckAccountHis('${checkAccount.applyId}')">历史</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
