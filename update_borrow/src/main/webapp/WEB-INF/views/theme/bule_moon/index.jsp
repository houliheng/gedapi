...
<![endif]-->
  <head>
    ...
    <!-- bootstrap css -->
    <script type="text/javascript" src="${themeStatic}/bule_moon/js/html5.js">
    </script>
    <link href="${themeStatic}/bule_moon/icomoon/style.css" rel="stylesheet">
    <!--[if lte IE 7]>
    <script src="css/icomoon-font/lte-ie7.js">
    </script>
    <![endif]-->
  <link href="${themeStatic}/bule_moon/css/wysiwyg/bootstrap-wysihtml5.css" rel="stylesheet">
  <link href="${themeStatic}/bule_moon/css/wysiwyg/wysiwyg-color.css" rel="stylesheet">
  <link href="${themeStatic}/bule_moon/css/main.css" rel="stylesheet"> 
  <!-- Important. For Theming change primary-color variable in main.css  -->
  <link href="${themeStatic}/bule_moon/css/charts-graphs.css" rel="stylesheet">
  </head>
  <body>
    <header>
      <a href="#" class="logo">
        <img src="${themeStatic}/bule_moon/img/logo.png" alt="logo" />
      </a>
                    ...
                    <div class="message-container">
                      <div class="message">
                        <div class="img-container">
                          <img src="${themeStatic}/bule_moon/img/profile.jpg" alt="">
                        </div>
                    ...
                    <div id="scrollbar-three">
                      ...
                      <div class="viewport">
                        <div class="overview">
                          <ul class="chats">
                            <li class="in">
                              <img class="avatar" alt="" src="${themeStatic}/bule_moon/img/profile.jpg">
                              <div class="message">
                                <span class="arrow">
                                </span>
                                <a href="#" class="name">
    ...
    <script src="${themeStatic}/bule_moon/js/wysiwyg/wysihtml5-0.3.0.js">
    </script>
    <script src="${themeStatic}/bule_moon/js/jquery.min.js">
    </script>
    <script src="${themeStatic}/bule_moon/js/bootstrap.js">
    </script>
    <script src="${themeStatic}/bule_moon/js/wysiwyg/bootstrap-wysihtml5.js">
    </script>
    <script src="${themeStatic}/bule_moon/js/jquery.scrollUp.js">
    </script>
    ...
    <!-- Easy Pie Chart JS -->
    <script src="${themeStatic}/bule_moon/js/jquery.easy-pie-chart.js">
    </script>
    
    <!-- Sparkline JS -->
    <script src="${themeStatic}/bule_moon/js/jquery.sparkline.js">
    </script>
    
    <!-- Tiny Scrollbar JS -->
    <script src="${themeStatic}/bule_moon/js/tiny-scrollbar.js">
    </script>
