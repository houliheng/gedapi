		...
		this.each(function(i, cont) {
			...
			var newList = {
				...
				dragStart: function(e) {
					...
					if(opts.dragStart(lists,list) == false){
						return;
					}
					...
					if (!opts.dragBetween||($(lists).index(list)==0&&opts.firstDragBetween)) {
...
//					}
	...
	$.fn.dragsort.defaults = {
		...
		dragEnd: function(data,thisData) { },
		dragStart: function(data,thisData) {return true},
		dragBetween: false,
		firstDragBetween: false,
		placeHolderTemplate: "",
