package com.resoft.postloan.plVideoPath.entity;

import com.thinkgem.jeesite.common.persistence.DataEntity;

public class PLVideoPath extends DataEntity<PLVideoPath> {
	private static final long serialVersionUID = 2983601958349264303L;
