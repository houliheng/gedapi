 ...
 * @version 2016-06-02
 */
public class DebtCollection extends DataEntity<DebtCollection> {
	...
	private String operateOrgName; // 登机门店(非表字段)
	private String currCollectionType; // 截至目前进行的催收方式（1未执行过催收2电话3上门4外包5法务）
	private String newCollectionType; // 新的目前进行的催收方式（转办用）（1未执行过催收2电话3上门4外包5法务）
	private String currCollectionFrom; // 截至目前的催收任务待分配来源（1逾期自动2电话转办3上门转办4外包转办5
										// null）
	...
	public DebtCollection(String id) {
		super(id);
	}
