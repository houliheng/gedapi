...
public class Constant {
	...
	protected static String fdfsConfFilePDF = "/fdfsPDF_client.conf";

	protected static String dbTableOwner = "cre";
	...
	protected static CreVieoPathService daoService;
	...
	public static void setDbSource(CreVieoPathService daoService) {
