 ...
 */
package com.resoft.credit.custinfo.entity;
...
public class CustInfo extends DataEntity<CustInfo> {
	...
	private BigDecimal estateValuation; //房产估值ESTATE_VALUATION
	...
	public BigDecimal getEstateValuation() {
		return estateValuation;
	}

	public void setEstateValuation(BigDecimal estateValuation) {
		this.estateValuation = estateValuation;
	}
