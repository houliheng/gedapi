package com.resoft.multds.credit.plCustRemoveBind.entity;
...
public class PLCustRemoveBind extends DataEntity<PLCustRemoveBind> {
	...
	public PLCustRemoveBind() {
		super();
	}

	public PLCustRemoveBind(String id) {
		super(id);
	}
