...
public class Contract extends DataEntity<Contract> {
	...
	private StaContractStatus staContractStatus;
	...
	public StaContractStatus getStaContractStatus() {
		return staContractStatus;
	}

	public void setStaContractStatus(StaContractStatus staContractStatus) {
		this.staContractStatus = staContractStatus;
	}
