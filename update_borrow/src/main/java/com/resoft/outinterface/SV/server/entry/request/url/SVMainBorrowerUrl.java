...
public class SVMainBorrowerUrl {
	@XmlElement(required=true,name="PIC_BEFORE_BOR")
	private List<SVRequestBaseData> picBefore;
	...
	public List<SVRequestBaseData> getPicBefore() {
		return picBefore;
	}
	public void setPicBefore(List<SVRequestBaseData> picBefore) {
