...
public class AbortiveTenderRequest extends DataEntity<AbortiveTenderRequest>{
	...
	public void setFeeList(List<FeeList> fee_list) {
		this.fee_list = fee_list;
	}
	...
	public String toString() {
		return "AbortiveTenderRequest [mchn=" + mchn + ", seq_no=" + seq_no
