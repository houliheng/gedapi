...
public class EnterAccountList{
	...
	private List<SettleList> settle_list;
	...
	public void setSettle_list(List<SettleList> settle_list) {
	...
	protected List<SettleList> getSettleList() {
		return settle_list;
	}
	protected void setSettleList(List<SettleList> settle_list) {
		this.settle_list = settle_list;
	}
	...
	public List<SettleList> getSettle_list() {
		return settle_list;
	}
}
