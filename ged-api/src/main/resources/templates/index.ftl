            ...
            <div class="pay_box" style="display:;">
                <div class="f_bg ov-hid pay_bank_tip p_box ">
                    <div class="suc_box">
                        ...
                        <p class="suc_tip_info"><strong>充值金额${reqForm.amt}元</strong> </p>
                        ...
                        <#if optype != "1">
                            <p>
                                <input class="suc_btn c_blue" type="button" onclick="window.location.href='${gedh5url}/paymentbank/paymentsucerr'" value="确认缴费">
                            </p>
                        <#else>
                            <p>
                                <input class="suc_btn c_blue" onclick="window.location.href='${gedh5url}/sponsor'"  type="button" value="返回">
                            </p>
                        </#if>
                        <p class="suc_tip_info f_s">详细请咨询客服热线：400-833-5050</p>
                    </div>
                </div>
            </div>
        <#else>
            <div class="pay_box" style="display:block;">
                <div class="f_bg ov-hid pay_bank_tip p_box ">
                    <div class="suc_box">
                        ...
                        <#else>
                            <p>
                                <input class="suc_btn c_blue" type="button" onclick="window.location.href='${gedh5url}/sponsor/recharge/epayment/compan'" value="重新充值">
                            </p>
                        </#if>
                        <p class="suc_tip_info f_s">详细请咨询客服热线：400-833-5050</p>
                    </div>
