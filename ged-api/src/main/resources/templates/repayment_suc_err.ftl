    ...
    <section>
            <#if resForm.resp_code == "0000">
                <div class="pay_box" style="display:;">
                    <div class="f_bg ov-hid pay_bank_tip p_box ">
                        <div class="suc_box">
                            <h5 class="suc_tip"><img src="/assets/suc_icon.jpg" alt width="78" height="78"> 交易成功</h5>
                            ...
                            <p>
                                <input class="suc_btn c_blue" onclick="window.location.href='${gedh5url}/orderlist/repayment'"  type="button" value="返回">
            ...
            <#else>
                <div class="pay_box" style="display:block;">
                    <div class="f_bg ov-hid pay_bank_tip p_box ">
                        <div class="suc_box">
                            <h5 class="suc_tip"><img src="/assets/d_faild.jpg" alt width="78" height="78"> 对不起，交易失败！</h5>
                        <#--<p class="suc_tip_info"><em>提现失败原因，{{exception}}</em> </p>-->

                            <p>
                                <input class="suc_btn c_blue" type="button"  onclick="window.location.href='${gedh5url}/loan/myrepayment'" value="重新充值">
                            </p><p class="suc_tip_info f_s">详细请咨询客服热线：400-833-5050</p>
                        </div>
                    </div>
                </div>
