...
public class PersonalAccountReqForm implements Serializable {
  private String mchn;// 系统代码（子商户）
  private String seq_no;// 交易流水号
  private String trade_type;// 交易类型
  private PersonalAccountReq data;// 数据域
  ...
  public PersonalAccountReq getData() {
    return data;
  }

  public void setData(PersonalAccountReq data) {
    this.data = data;
  }
