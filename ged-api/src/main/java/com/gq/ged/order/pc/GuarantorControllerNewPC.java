...
import com.gq.ged.order.service.OrderGuarantLoanNewService;
...
@RestController
@RequestMapping(value = "/v2/pc/guarantor", produces = MediaType.APPLICATION_JSON_VALUE)
public class GuarantorControllerNewPC extends BaseController {

  @Resource
  OrderGuarantLoanNewService guarantLoanService;
