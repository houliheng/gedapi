...
public interface OrderService {
   ...
   * @throws Exception
   */
  RepayPlanTotleResForm selectOrderStatus(long userId) throws Exception;
   ...
   * @param reqForm
   */
  public void updateContract(OrderConTractListForm reqForm) throws Exception;
   ...
   * @return
   */
  public GedServiceGuarFlagResForm confirWithDrawCash(User userInfo, String orderNo) throws Exception;
  ...
  public BigDecimal accountBalance(String orderNo,Long userId) throws Exception;
    ...
    /**
     * 资金管理首页
     * 1  转向费用支付页面  2 转向无此订单页面 3转向订单查看页面
     * @param userId
     * @return
     */
  ...
  public RechargeReForm userRechargeForRepayment(Long  userId, String bankId ,String amt ,String periodNum , Integer type) throws Exception;
   ...
   * @throws Exception
   */
  public void userRechargeCallBackForRepayment(String   orderNo,String amt , PayCallBackReqForm res) throws Exception;
   ...
   * @return
   */
  public GeneratePayParas generatePayParas(String seqNum , String loginName,String orderNo,Long userId,String orderPayType ,String issinscd);
   ...
   * @return
   */
  public GeneratePayParas generatePayParasForRepayment(String seqNum , String loginName,String orderNo,Long userId,String orderPayType ,String issinscd , String amt);
   ...
   * @return
   */
  public PageInfo<GedOrder> getOrdersPageByCondition(GedOrder gedOrder  , Integer pageNum,Integer pageSize);
   ...
   * @param contractNo
   */
  void updateOrderByContractNo(String contractNo);
   ...
   * @return
   */
  public GedOrder selectByContract(String contract);
}
